...
export const LISTAS_ADMIN_INICIALES: ListaAdmin[] = [
  ...
  { nombre: 'Unidad Funcional (OPAS)', opciones: opcionesDesdeTextos(UNIDADES_FUNCIONALES_MAESTRAS.slice(0, 30)) },
...
export const CATALOGOS_SISTEMA_REGISTRADOS: CatalogoSistema[] = [
  ...
  { nombre: 'Unidad Funcional (OPAS)', alias: ['unidad funcional', 'unidad funcional opas', 'opas', 'unidad funcional (opas)'], opciones: [...UNIDADES_FUNCIONALES_MAESTRAS] },
